...
import img64 from "./img/products-photo/1a74988851752e5e83c145c4753861c_800x.webp";
import img65 from "./img/products-photo/blue-hat-graphics-blue-baby-shoes-7238774_1280.png";
import img66 from "./img/products-photo/blue-hat-graphics-pink-baby-shoes-7238781_1280.png";
import img67 from "./img/products-photo/Blue-Sapphire-Hand-Engraved-Men-Ring-1.webp";
import img68 from "./img/products-photo/clker-free-vector-images-socks-306802_1280.png";
import img69 from "./img/products-photo/clker-free-vector-images-socks-310898_1280.png";
import img70 from "./img/products-photo/Men_s_Necklaces.webp";
import img71 from "./img/products-photo/mochaclassicfront_938x.webp";
import img72 from "./img/products-photo/Sb8749f83e1e54700b2762658642aec45x.webp";
import img73 from "./img/products-photo/T_BT_753_BR_1_1080x.webp";
...
let productsdata = [
    ...
    },
    {
        ...
        imgs: [img35, img35],
        colors_sizes: [
            { colorNameInArabic: "أزرق غامق", price: "260" },
            { colorNameInArabic: "أسود", price: "265" }
        ],
        comments: [
    ...
    },
    {
        ...
        imgs: [img36, img36],
        colors_sizes: [
            { colorNameInArabic: "أحمر", price: "280" },
            { colorNameInArabic: "أزرق", price: "285" }
        ],
        comments: [
    ...
    },
    {
        ...
        imgs: [img37, img37],
        colors_sizes: [
            { colorNameInArabic: "بني", price: "270" },
            { colorNameInArabic: "أسود", price: "275" }
        ],
        comments: [
    ...
    },
    {
        ...
        imgs: [img38, img38],
        colors_sizes: [
            { colorNameInArabic: "ذهبي", price: "95" },
            { colorNameInArabic: "فضي", price: "90" }
        ],
        comments: [
    ...
    },
    {
        ...
        imgs: [img39, img39],
        colors_sizes: [
            { colorNameInArabic: "أزرق وأبيض", price: "145" },
            { colorNameInArabic: "أحمر وأبيض", price: "150" }
        ],
        comments: [
    ...
    },
    {
        ...
        imgs: [img40, img40],
        colors_sizes: [
            { colorNameInArabic: "أسود", price: "175" },
            { colorNameInArabic: "رمادي", price: "180" }
        ],
        comments: [
    ...
    },
    {
        ...
        imgs: [img41, img41],
        colors_sizes: [
            { colorNameInArabic: "أزرق", price: "290" },
            { colorNameInArabic: "أسود", price: "295" }
        ],
        comments: [
    ...
    },
    {
        ...
        imgs: [img42, img42],
        colors_sizes: [
            { colorNameInArabic: "وردي", price: "85" },
            { colorNameInArabic: "أزرق", price: "90" }
        ],
        comments: [
    ...
    },
    {
        ...
        imgs: [img43, img43],
        colors_sizes: [
            { colorNameInArabic: "بني", price: "180" },
            { colorNameInArabic: "أخضر", price: "185" }
        ],
        comments: [
    ...
    },
    {
        ...
        imgs: [img44, img44],
        colors_sizes: [
            { colorNameInArabic: "أبيض", price: "310" },
            { colorNameInArabic: "أزرق", price: "315" }
        ],
        comments: [
    ...
    },
    {
        ...
        imgs: [img45, img45],
        colors_sizes: [
            { colorNameInArabic: "أسود", price: "340" },
            { colorNameInArabic: "بني", price: "345" }
        ],
        comments: [
    ...
    },
    {
        ...
        imgs: [img46, img46],
        colors_sizes: [
            { colorNameInArabic: "فضي", price: "65" },
            { colorNameInArabic: "ذهبي", price: "70" }
        ],
        comments: [
    ...
    },
    {
        ...
        imgs: [img47, img47],
        colors_sizes: [
            { colorNameInArabic: "أحمر وأسود", price: "165" },
            { colorNameInArabic: "أزرق وأسود", price: "170" }
        ],
        comments: [
    ...
    },
    {
        ...
        imgs: [img48, img48],
        colors_sizes: [
            { colorNameInArabic: "وردي", price: "195" },
            { colorNameInArabic: "أبيض", price: "200" }
        ],
        comments: [
    ...
    },
    {
        ...
        imgs: [img49, img49],
        colors_sizes: [
            { colorNameInArabic: "أزرق فاتح", price: "220" },
            { colorNameInArabic: "رمادي", price: "225" }
        ],
        comments: [
    ...
    },
    {
        ...
        imgs: [img50, img50],
        colors_sizes: [
            { colorNameInArabic: "أسود", price: "185" },
            { colorNameInArabic: "أزرق", price: "190" }
        ],
        comments: [
    ...
    },
    {
        ...
        imgs: [img51, img51],
        colors_sizes: [
            { colorNameInArabic: "أبيض", price: "115" },
            { colorNameInArabic: "أزرق", price: "120" }
        ],
        comments: [
    ...
    },
    {
        ...
        imgs: [img52, img52],
        colors_sizes: [
            { colorNameInArabic: "أسود", price: "210" },
            { colorNameInArabic: "بني", price: "215" }
        ],
        comments: [
    ...
    },
    {
        ...
        imgs: [img53, img53],
        colors_sizes: [
            { colorNameInArabic: "رمادي", price: "270" },
            { colorNameInArabic: "بني", price: "275" }
        ],
        comments: [
    ...
    },
    {
        ...
        imgs: [img54, img54],
        colors_sizes: [
            { colorNameInArabic: "أحمر", price: "110" },
            { colorNameInArabic: "أسود", price: "115" }
        ],
        comments: [
    ...
    },
    {
        ...
        imgs: [img55, img55],
        colors_sizes: [
            { colorNameInArabic: "أسود", price: "200" },
            { colorNameInArabic: "رمادي غامق", price: "205" }
        ],
        comments: [
    ...
    },
    {
        ...
        imgs: [img56, img56],
        colors_sizes: [
            { colorNameInArabic: "أزرق", price: "260" },
            { colorNameInArabic: "أرجواني", price: "265" }
        ],
        comments: [
    ...
    },
    {
        ...
        imgs: [img57, img57],
        colors_sizes: [
            { colorNameInArabic: "أبيض", price: "300" },
            { colorNameInArabic: "أسود", price: "305" }
        ],
        comments: [
    ...
    },
    {
        ...
        imgs: [img58, img58],
        colors_sizes: [
            { colorNameInArabic: "ذهبي", price: "80" },
            { colorNameInArabic: "فضي", price: "75" }
        ],
        comments: [
    ...
    },
    {
        ...
        imgs: [img59, img59],
        colors_sizes: [
            { colorNameInArabic: "أبيض", price: "150" },
            { colorNameInArabic: "أزرق", price: "155" }
        ],
        comments: [
    ...
    },
    {
        ...
        comments: [
            { id: 74, text: "أقراط جميلة وتصميمها رائع" }
        ]
    },
    {
        id: 69,
    ...
    },
    {
        ...
        colors_sizes: [],
        comments: [
            { id: 79, text: "كلاسيكي وعالي الجودة" },
            { id: 80, text: "المقاسات دقيقة والقماش متين" }
        ]
    }
];
